...
<div class="items-center -mx-2 md:flex">
            ...
            <div class="flex justify-center mt-6">
                <button  class="px-4 py-2 text-white transition-colors duration-200 transform bg-blue-900 rounded-md hover:bg-blue-700 focus:outline-none focus:bg-gray-600">Update category</button>
            </div>
        </form>
    </section>
