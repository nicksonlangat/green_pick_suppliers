      ...
      <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white"></span>
                ...
                <div class="items-center lg:flex">
                    <div class="flex flex-col mt-4 space-y-8 lg:flex-row lg:items-center lg:mt-0 lg:space-y-0 lg:space-x-16">
                        ...
                        <router-link v-if="loggedIn" class="block font-medium bg-gray-200 rounded shadow px-2 text-blue-900 dark:text-gray-200 hover:text-gray-900 dark:hover:text-gray-400 hover:underline" to="/suppliers">MY ORDERS</router-link>
...
export default {
    ...
    created(){
        ...
        if(!user.user.is_superuser && user.user.role!="Supplier"){
            this.$router.push({ name: "Login"})
        }
