<template>
    ...
    <section class="">
    <p class="text-3xl text-center">Hello {{user.user.name}}, welcome back. You have {{orders.length}} new orders on this page.</p>
    </section>
            <!-- Column -->
          ...
          <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
            <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
              <table class="min-w-full divide-y divide-gray-200">
                <modal4 v-if="modalVisible" @close="modalVisible = false" :data="modalData"/>
    ...
    export default {
      ...
      methods:{
        ...
        return axios.get(`https://api.greenpick.store/orders/?page=${this.page}&order_status=Approved&is_fulfilled=false`, config).then(res=>{
